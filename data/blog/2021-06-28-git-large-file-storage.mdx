...
date: '2021-06-28'
draft: false
summary: Github를 이용해서 우리들은 많은 소스들을 손쉽게 관리할 수 있습니다. 하지만, 때로는 용량이 너무 큰 파일때문에 곤란한 경우가 생기기도 하는데요. git에서는 일반적으로 100MB 이상의 파일에 대해서 PUSH를 할 수가 없습니다. 오늘은 이 경우에 대해서 어떻게 대처를 할 것인가에 대해서 알아보도록 하겠습니다.
---
...
![/assets/images/git-large-file-storage/1.png](/static/images/blog/git-large-file-storage/1.png)
...
> ```
>
> ![/assets/images/git-large-file-storage/2.png](/static/images/blog/git-large-file-storage/2.png)
>
...
> ```
>
> ![/assets/images/git-large-file-storage/3.png](/static/images/blog/git-large-file-storage/3.png)
>
