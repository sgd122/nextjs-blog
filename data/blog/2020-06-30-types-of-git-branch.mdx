...
date: '2020-06-30'
draft: false
summary: Gitflow Workflow에서는 항상 유지되는 메인 브랜치들(master, develop)과 일정 기간 동안만 유지되는 보조 브랜치들(feature, release, hotfix)을 포함하여 총 5가지의 브랜치를 사용한다.
---
...
![](/static/images/blog/types-of-git-branch/total-branch.png)
...
즉, 배포 가능한 상태만을 관리한다.
![](/static/images/blog/types-of-git-branch/develop-branch.svg)
...
![](/static/images/blog/types-of-git-branch/develop-branch.png)
...
![](/static/images/blog/types-of-git-branch/feature-branch.svg)
...
- <mark>--no-ff 옵션</mark>
  ...
  - ![](/static/images/blog/types-of-git-branch/feature-branch-merge.png)
...
![](/static/images/blog/types-of-git-branch/release-branch.svg)
...
![](/static/images/blog/types-of-git-branch/hotfix-branch.png)
...
![](/static/images/blog/types-of-git-branch/hotfix-branch.svg)
