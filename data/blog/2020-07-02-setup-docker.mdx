...
date: '2020-07-02'
draft: false
summary: 도커Docker는 2013년에 등장한 컨테이너 기반 가상화 도구입니다. 이 글은 도커 입문자를 위한 튜토리얼로서, 도커의 설치 방법에 대해서 기술해 놓았습니다.
---
...
![/assets/images/setup-docker/10.png](/static/images/blog/setup-docker/10.png)

윈도우 버전은 명령 프롬프트에서 ver 명령으로도 확인 가능합니다.

![/assets/images/setup-docker/11.png](/static/images/blog/setup-docker/11.png)
...
![/assets/images/setup-docker/12.png](/static/images/blog/setup-docker/12.png)
...
![/assets/images/setup-docker/13.png](/static/images/blog/setup-docker/13.png)
...
![/assets/images/setup-docker/14.png](/static/images/blog/setup-docker/14.png)
...
![/assets/images/setup-docker/15.png](/static/images/blog/setup-docker/15.png)
...
![/assets/images/setup-docker/16.png](/static/images/blog/setup-docker/16.png)

위와 같이 버전1로 확인이 된다면, “wsl --set-version [배포판이름] 2” 명령으로 WSL 버전2로 올리실 수 있습니다. 반대로 버전2를 버전1으로 내리는 것도 가능합니다.

![/assets/images/setup-docker/17.png](/static/images/blog/setup-docker/17.png)

### 7. WSL 디폴트 배포판 설정하기

“wsl --set-default [배포판이름]” 명령으로 wsl 디폴트 배포판을 설정하실 수 있습니다.

![/assets/images/setup-docker/18.png](/static/images/blog/setup-docker/18.png)
...
![/assets/images/setup-docker/01.png](/static/images/blog/setup-docker/01.png)

![/assets/images/setup-docker/02.png](/static/images/blog/setup-docker/02.png)

- VirtualBox에서 머신폴더를 마운트합니다.

![/assets/images/setup-docker/03.png](/static/images/blog/setup-docker/03.png)

![/assets/images/setup-docker/04.png](/static/images/blog/setup-docker/04.png)
...
![/assets/images/setup-docker/19.png](/static/images/blog/setup-docker/19.png)
...
![/assets/images/setup-docker/05.png](/static/images/blog/setup-docker/05.png)

![/assets/images/setup-docker/06.png](/static/images/blog/setup-docker/06.png)
...
![/assets/images/setup-docker/07.png](/static/images/blog/setup-docker/07.png)

![/assets/images/setup-docker/08.png](/static/images/blog/setup-docker/08.png)
...
![/assets/images/setup-docker/20.png](/static/images/blog/setup-docker/20.png)

다음과 같이 docker-desktop 배포판을 확인하실 수 있습니다.

![/assets/images/setup-docker/21.png](/static/images/blog/setup-docker/21.png)
...
![/assets/images/setup-docker/09.png](/static/images/blog/setup-docker/09.png)
