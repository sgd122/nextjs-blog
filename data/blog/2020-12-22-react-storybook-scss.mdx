...
date: '2020-12-22'
draft: false
summary: 들어가기에 앞서, 본 프로젝트는 TypeScript/CRA기반의 Storybook에서 진행하였습니다. 1. Storybook에서 Scss 사용 및 classnames를 사용하기 위해서 아래의 내역을 install 한다.
---
...
![image1](/static/images/blog/react-storybook-scss/image1.png)
