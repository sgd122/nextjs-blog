...
date: '2020-07-13'
draft: false
summary: 슬랙(Slack)은 굉장히 많은 회사와 동아리 등의 집단에서 사용하고 있는 협업 메신저 도구입니다. 쉽게 말하면 회사용 카카오톡(Kakao Talk) 정도라고 보시면 됩니다.
---
...
![/assets/images/slack-tag/content_01.png](/static/images/blog/slack-tag/content_01.png)
**Edit profile**을 눌러서 사진도 업로드하고 이름도 바꾸셔서 프로필을 완성해보세요.

### 다양한 플랫폼 지원

![/assets/images/slack-tag/content_02.jpg](/static/images/blog/slack-tag/content_02.jpg)
...
![/assets/images/slack-tag/content_03.png](/static/images/blog/slack-tag/content_03.png)
