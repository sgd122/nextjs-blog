...
tags: [python, Django, drf, djang-rest-framework, Serializers]
date: '2020-12-28'
draft: false
summary: serializer란 쿼리셋, 모델 인스턴스 등의 복잡한 데이터를 JSON, XML 등의 컨텐트 타입으로 쉽게 변환 가능한 python datatype으로 변환시켜줌
---

## Serializer란??

> **serializer**: 쿼리셋, 모델 인스턴스 등의 복잡한 데이터를 JSON, XML 등의 컨텐트 타입으로 쉽게 변환 가능한 python datatype으로 변환시켜줌
